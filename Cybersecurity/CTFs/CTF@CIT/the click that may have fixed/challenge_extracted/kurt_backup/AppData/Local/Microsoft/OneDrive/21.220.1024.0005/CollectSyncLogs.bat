...
CALL :LogRegkey "\Classes\Interface\{5d65dd0d-81bf-4ff4-aeea-6effb445cb3f}", "/s", "%WORKINGDIRONEDRIVE%\reg_COM.txt", HKCU\Software, HKLM\Software, HKLM\Software\WOW6432Node
...
CALL :LogRegkey "\Classes\Interface\{f0440f4e-4884-4a8F-8a45-ba89c00f96f2}", "/s", "%WORKINGDIRONEDRIVE%\reg_COM.txt", HKCU\Software, HKLM\Software, HKLM\Software\WOW6432Node
CALL :LogRegkey "\Classes\Interface\{0776ae27-5ab9-4e18-9063-1836da63117a}", "/s", "%WORKINGDIRONEDRIVE%\reg_COM.txt", HKCU\Software, HKLM\Software, HKLM\Software\WOW6432Node
...
CALL :LogRegkey "\Classes\Interface\{53de12aa-df96-413d-a25e-c75b6528abf2}", "/s", "%WORKINGDIRONEDRIVE%\reg_COM.txt", HKCU\Software, HKLM\Software, HKLM\Software\WOW6432Node
...
CALL :LogRegkey "\Classes\Interface\{049FED7E-C3EA-4B66-9D92-10E8085D60FB}", "/s", "%WORKINGDIRONEDRIVE%\reg_COM.txt", HKCU\Software, HKLM\Software, HKLM\Software\WOW6432Node
CALL :LogRegkey "\Classes\Interface\{2387C6BD-9A36-41A2-88ED-FF731E529384}", "/s", "%WORKINGDIRONEDRIVE%\reg_COM.txt", HKCU\Software, HKLM\Software, HKLM\Software\WOW6432Node
