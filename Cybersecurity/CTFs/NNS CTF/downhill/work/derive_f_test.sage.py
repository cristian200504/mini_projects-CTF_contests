...
# This file was *autogenerated* from the file derive_f_test.sage
...
d_val = QQ(d[_sage_const_0 ]) if d.degree() <= _sage_const_0  else None
...
print("f_cand coeffs sample:", f_cand.list()[:_sage_const_20 ])
print("true_f coeffs sample:", f_true.list()[:_sage_const_20 ])
